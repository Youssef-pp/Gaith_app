      ...
      {
        {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            ...
            const SnackBar(backgroundColor: Colors.red,content: Center(child: Text('تاكد من كلمه المرور والبريد الكترونى'))),
          );
        }
      }
            ...
            children: [
              ...
              CustomTextFormField(
                ...
                subfix: IconButton(onPressed: (){
                  ...
                  icon: Icon(BlocProvider.of<RegisterViewCubit>(context).subfix,color: const Color(0xff22AAE4 ),size: 30.0),),
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text('تسجيل دخول',
                      style: TextStyle( color: const Color(0xff22AAE4),
