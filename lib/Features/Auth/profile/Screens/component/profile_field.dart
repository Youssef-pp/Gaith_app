        ...
        builder: (context,state){
          ...
          return ConditionalBuilder(
             ...
             builder: (context)=>   Column(
              ...
              fallback: (context) => SizedBox(height: MediaQuery.of(context).size.height,width:MediaQuery.of(context).size.width,child: const Center(child: CircularProgressIndicator(color: Color(0xff529C9C),))));
