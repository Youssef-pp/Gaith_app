...
class DonationNeedViewCubit extends Cubit<DonationNeedViewState> {
  ...
  void requestADonationForMe({
    ...
    DioHelper.postData(url: 'need_donation_me', data: formData).then((value) {
      print(value.data);
      print(image);
  ...
  Future<void> requestADonationToAnotherPerson(
    ...
    DioHelper.postData(url: 'need_donation_you', data: formData).then((value) {
      print(value.data);
      print(imageUrl);
