          ...
          child: BlocConsumer<DonationNeedViewCubit, DonationNeedViewState>(
                    ...
                    builder: (_) => AlertDialog(
                      ...
                      content: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'سيتم مراجعه طلبك والتواصل معك فى اقرب وقت ممكن ',
                            style: TextStyle(
                              fontSize: 18.0,
                              fontFamily: 'Ottoman',
                              color: Colors.black,
              ...
              if (state is RequestADonationToAnotherPersonStateError) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                      backgroundColor: Colors.red,
                      content: Text(
                          'لم يتم تنفيذ التبرع حاول مره اخرى وتاكد من الانترنت')),
                );
              }
            },
            builder: (context, state) {
              return SingleChildScrollView(
                child: Column(
                  children: [
                    if (BlocProvider.of<DonationNeedViewCubit>(context)
                            .donationPhoto !=
                        null)
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(
                                16.0), // تعديل نسبة القطع حسب الحاجة
                            child: Image.file(
                              File(BlocProvider.of<DonationNeedViewCubit>(
                                      context)
                                  .donationPhoto!
                                  .path),
                              fit: BoxFit.cover,
                    ...
                    CustomTextFormField(
                      hintText: 'إسم الحاله المحتاجه التبرع',
                    ...
                    CustomTextFormField(
                      hintText: 'رقم موبيل صاحب الحاله',
                    ...
                    Row(
                      ...
                      children: [
                        InkWell(
                            onTap: () {
                              BlocProvider.of<DonationNeedViewCubit>(context)
                    ...
                    Padding(
                      ...
                      child: ConditionalBuilder(
                        condition: state
                            is! RequestADonationToAnotherPersonStateLoading,
                        builder: (context) => DefaultButton(
                          text: 'تأكيد',
                          function: () {
                            if (keyForm.currentState!.validate()) {
                              BlocProvider.of<DonationNeedViewCubit>(context)
                                  .requestADonationToAnotherPerson(
                                ...
                                imageUrl:
                                    BlocProvider.of<DonationNeedViewCubit>(
                                            context)
                                        .donationPhoto,
                                price: '0',
                              );
