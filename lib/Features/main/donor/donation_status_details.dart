                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            ,
            style:GoogleFonts.cairo(textStyle: TextStyle(fontSize: 14.sp,color: const Color(0xff555555),fontWeight: FontWeight.w600)
            ) ),
                          10.verticalSpace,

                          Row(
                            children: [
                              Icon(FeatherIcons.phone,color: const Color(0xff22AAE4),),
                              5.horizontalSpace,
                          ...
                          Row(
                            children: [
                              Icon(FeatherIcons.map,color: const Color(0xff22AAE4),),
                              5.horizontalSpace,
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: LinearProgressBar(
                                      ...
                                      progressColor:const Color(0xff22AAE4),
                                  ...
                                  Card(elevation:2,child: Container(width: 50.w,height:18.h,decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: const Color(0xff22AAE4)),child: Center(child:
                                  ...
                                  )*100}%',style: const TextStyle(color: Colors.white,fontWeight: FontWeight.bold),))
                                  ))
                                ],
                              ),
                              Padding(
                        ...
                        Expanded(
                            ...
                            child:  Container(
                              ...
                              child: MaterialButton(
                                  ...
                                  child:
                                  const Icon(Icons.add_shopping_cart, color: Color(0xff22AAE4),size: 25,)
