...
class OtherDonationsListView extends StatelessWidget {
  const OtherDonationsListView({super.key});
                  ...
                  builder: (_) => AlertDialog(
                    ...
                    content: Column(
                      ...
                      children: [
                        ...
                        Text('${state.successModel!.message}',  style: const TextStyle(
                          fontSize: 18.0,
                          fontFamily: 'Ottoman',
                          color: Colors.black,
                          fontWeight: FontWeight.bold,
                        ),),
                        const Text('شكر على تبرعك معانا ',  style: TextStyle(
                          fontSize: 18.0,
                          fontFamily: 'Ottoman',
                          color: Colors.black,
                          fontWeight: FontWeight.bold,
                        ),),
                        const Text('سيتم ارسال مندوب لك للاستلام تبرعك', style: TextStyle(
                          fontSize: 18.0,
                          fontFamily: 'Ottoman',
                          color: Colors.black,
                          fontWeight: FontWeight.bold,
            ...
            if(state is AddDonationStateError)
              {
                ScaffoldMessenger.of(context).showSnackBar(
                  ...
                  const SnackBar(backgroundColor: Colors.red,content: Text('لم يتم تنفيذ التبرع حاول مره اخرى وتاكد من الانترنت')),
                );
              }
                      ...
                      children: [
                        Stack(
                          ...
                          children: [
                            ...
                            IconButton(onPressed: (){navigapop(context);}, icon: const Icon(Icons.arrow_back_ios))
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            } ,child: const Icon(Icons.camera_alt,color: Color(0xff529C9C),)),
                            InkWell(onTap:(){
